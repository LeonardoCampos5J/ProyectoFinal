...
<?php
    ...
    $sql2 = "SELECT * FROM compras WHERE usuario = '$corr'";
...
<body> 
    ...
    <div class="principal">
        <div class="titulo-principal">
            <h3>Tus Pedidos <?php echo $nombre; ?> </h3>
        </div>
                        ...
                        <div class="card mb-1" style="max-width: auto; margin:30px">
                            <div class="row g-0">
                                ...
                                <div class="col-md-9" style="display:flex; ">
                                    <div class="card-body">
                                        <h4 class="card-title"> <?php echo $producto->nombreProducto; ?> </h4>
                                        <h5 class="card-text"> <?php echo $producto->precioProducto; ?></h5>
