...
<body>
                    ...
                    <div>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item" style="margin: 10px;">
                                <center><a  href="src/vistas/administrador/administrador.php">Registro de Usuarios</a></center>
                            </li>
                            <li class="nav-item" style="margin: 10px;">
                                <center><a  href="catalogoAdmin.php">Catalogo de Productos</a></center>
                            </li>
                            <li class="nav-item" style="margin: 10px;">
                                <center><a  href="src/vistas/administrador/eliminarAdmin.php">Eliminar Proveedores</a></center>
                            </li>
                            <li class="nav-item" style="margin: 10px;">
                                <center><a  href="src/vistas/administrador/pedidosAdmin.php">Pedidos de Clientes</a></center>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="producto">
        <center><h1 class="titulo">Catàlogo Administrador CaféTux</h1></center>
        <center><i>PRODUCTOS<hr> </i></center> 
        <br><br>
        <div class="contenedor-items">
            <?php foreach($registros as $fila) : ?>
                <center>
                    <div class="item" style="border: 1px solid black; width: 30%; margin:10px;">
                        ...
                        <a href="src/controlador/borrarProducto.php?nombre=<?php echo $fila->NombreProducto; ?>" class="btn btn-danger" style="margin:10px">Borrar Producto</a>
